...
N 1000 -740 1180 -740 {lab=A,PCTR[3:0]}
...
C {gf180/integrator/xschem/integrator_RO5St.sym} 670 -760 0 0 {name=xROCTR}
C {gf180/integrator/xschem/integrator_RO5St.sym} 1780 -760 0 0 {name=xROREF}
...
C {gf180/integrator/xschem/integrator_phasedetector.sym} 1280 -720 0 0 {name=xMPD}
...
C {lab_wire.sym} 1050 -740 0 1 {name=p1 sig_type=std_logic lab=A,PCTR[3:0]}
...
C {title.sym} 160 -40 0 0 {name=l1 author="Sergio Carreño"}
