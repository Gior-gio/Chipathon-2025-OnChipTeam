...
#   text files in the *entire current directory* to update cross-references.
#
# Usage:
...
echo "  - Text content inside all files in the current directory will be changed from '$ORIGINAL_NAME' to '$NEW_NAME'"
echo "------------------------------------------------------------------"
...
# --- Step 4: Find and Replace content in files throughout the current directory ---

echo "[ACTION] Replacing content in all text files throughout the current directory ('.')..."
# The directory to search is the entire current directory to catch cross-references.
search_dir="."
